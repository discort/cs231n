...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params['W2'] = weight_scale * np.random.randn(num_filters * HH * WW, hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        scores, relu_cache = affine_relu_forward(scores, W2, b2)
        ...
        dx, dw, db = affine_relu_backward(dx, (relu_cache[0], fc_cache[0]))
        dw += self.reg * W2
        grads['W2'] = dw
        grads['b2'] = db
